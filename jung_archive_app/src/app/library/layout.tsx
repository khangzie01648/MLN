...
export const metadata: Metadata = {
    title: 'Thư Viện Số Carl Jung (The Digital Library)',
...
export default function LibraryLayout({
    ...
    return (
        <div className={`${cinzel.variable} ${inter.variable} ${playfair.variable} bg-[#0a0b10] text-[#ececec] min-h-screen font-sans`}>
