        ...
        <div className="min-h-screen bg-[#000508] text-white selection:bg-amber-500 selection:text-black font-light leading-relaxed">
            ...
            <nav className="sticky top-0 z-50 bg-[#000508]/90 backdrop-blur-xl border-b border-white/5 py-6 font-cinzel">
                <div className="max-w-[1200px] mx-auto px-8 flex justify-between items-center">
                    <Link href={`/pillar/${pillarId}`} className="group flex items-center gap-4">
            ...
            <main className="max-w-[1200px] mx-auto px-8 py-32 relative z-10">
                ...
                <footer className="mt-48 pt-24 border-t border-white/5 text-center">
                    ...
                    <div className="flex flex-col md:flex-row gap-8 justify-center items-center">
                        <Link href={`/pillar/${pillarId}`} className="px-12 py-5 rounded-xl border border-amber-500/20 text-amber-500 hover:bg-amber-500/10 transition-all font-cinzel tracking-[0.4em] text-xs uppercase group">
                            Quay lại <span className="text-white group-hover:text-amber-400 transition-colors">{pillarData?.nameVi}</span>
                        </Link>
                        <Link href="/library" className="px-12 py-5 rounded-xl bg-amber-500 text-black font-cinzel tracking-[0.4em] text-xs uppercase font-bold hover:bg-white transition-all shadow-[0_0_50px_rgba(245,158,11,0.2)]">
                            Thư viện Tổng
                        </Link>
                    </div>
                </footer>
